			...
			>
				<SwiperSlide>
					<div className="relative w-full h-[60vh] md:h-[85vh]">
						...
						/>
						<h1 className="text-center lg:text-start w-4/5 lg:w-max absolute top-8 left-1/2 -translate-x-1/2 text-4xl md:text-5xl font-bold text-dark">
				...
				<SwiperSlide>
					<div className="relative w-full h-[60vh] md:h-[85vh]">
						<img
							...
							className="w-full h-full object-cover object-center"
						/>
						<h1 className="text-center lg:text-start w-4/5 lg:w-max absolute top-8 left-1/2 -translate-x-1/2 text-4xl md:text-5xl font-bold text-light">
